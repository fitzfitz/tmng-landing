...
export function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-black/95 text-purple-100 flex font-sans">
            ...
            >
              <item.icon
                ...
                className={cn(
                  ...
                  isActive(item.href)
                    ? "text-fuchsia-400"
                    : "text-purple-200/40 group-hover:text-purple-200",
                )}
              />
              {item.title}
            </Link>
          ...
          <Popover>
            <PopoverTrigger className="w-full flex items-center gap-3 p-2 rounded-xl hover:bg-white/5 transition-colors group outline-none">
              ...
              <div className="flex-1 text-left overflow-hidden">
                <p className="text-sm font-medium text-white group-hover:text-fuchsia-200 transition-colors truncate">
                  {user?.name || "Admin"}
                </p>
              ...
              <ChevronUp
                size={16}
                className="text-purple-200/50 group-hover:text-purple-200 transition-colors"
              />
            </PopoverTrigger>
            <PopoverContent
              className="w-80 p-1 border-white/10 bg-zinc-950/90 backdrop-blur-2xl shadow-xl shadow-black/50"
              side="top"
              align="center"
              sideOffset={16}
            >
              ...
              <div className="flex flex-col gap-1 p-1">
                <button
                  disabled
                  className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-purple-100/40 cursor-not-allowed w-full text-left"
                >
                  <UsersRound size={16} />
                  Profile & Account
                </button>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-red-400/80 hover:text-red-300 hover:bg-red-500/10 rounded-lg transition-all w-full text-left"
                >
                  <LogOut size={16} />
                  Sign Out
                </button>
