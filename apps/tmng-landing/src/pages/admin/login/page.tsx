      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-8 rounded-3xl shadow-2xl ring-1 ring-white/5">
          <div className="text-center mb-8">
            <div className="mx-auto w-12 h-12 bg-gradient-to-br from-fuchsia-500 to-purple-600 rounded-xl mb-4 shadow-lg shadow-purple-500/20 flex items-center justify-center">
