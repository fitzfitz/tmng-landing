...
export const createHandler = factory.createHandlers(zValidator("json", createPortfolioSchema), async (c) => {
...
export const updateHandler = factory.createHandlers(zValidator("json", updatePortfolioSchema), async (c) => {
