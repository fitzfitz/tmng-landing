...
import { listPostsHandler, getPostByIdHandler, createPostHandler, updatePostHandler, deletePostHandler, publishPostHandler, unpublishPostHandler, } from './posts.handlers';
// Admin posts router - authentication required
const adminPostsApp = new Hono()
