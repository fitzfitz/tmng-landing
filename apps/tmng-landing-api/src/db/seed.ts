...
const mockProjects = [
  {
    ...
    content:
      "Built with React, Tailwind CSS, and Recharts. Features real-time data visualization, inventory management, and order tracking.",
    client: "RetailCo",
    category: "Web App",
  ...
  },
  {
    ...
    content:
      "Responsive design with smooth scroll animations and booking integration.",
...
async function seed() {
  ...
  try {
    ...
    await db.insert(portfolioItems).values(mockProjects as any);
